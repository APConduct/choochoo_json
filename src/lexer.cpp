...
namespace choochoo::json {
    ...
    char Lexer::current_char() const { return position_ < input_.size() ? input_[position_] : '\0'; }
    ...
    Lexer::Lexer(std::string_view input) : input_(input), position_(0), line_(1), column_(1) {}
